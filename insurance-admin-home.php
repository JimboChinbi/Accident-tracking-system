    ...
    if ($result_user){
        ...
        if (!isset ($_GET['submission_filter']) ) {
            ...
            if ($search == "all"){
                ...
                $sql = "SELECT * FROM Incidents WHERE insurance_status = '$search' LIMIT ".$page_first_result.",".$results_per_page;
                $result_data = mysqli_query($conn, $sql);
            }
        }
    }else{
...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding-left: 30px; padding-right: 30px; background-color: #5632D9 !important;">
    <div class="container-fluid row">
        <a class="navbar-brand col-sm-12 col-lg-10 caption" href="insurance-admin-home.php" style="color: #F8F8F8 !important;">Accident Claim System</a>
        <ul class="desktop navbar-nav ml-auto" style="max-width: fit-content">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="insurance-admin-home.php"  style="color: #F8F8F8 !important;font-weight: bold;">Home</a>
            </li>
        </ul>
    </div>
</nav>
                    ...
                    <div class="table-responsive">
                        <table class="table table-light shadow-lg table-bordered" style="margin-top: 8%; margin-top: 8%;">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="align-middle" style="min-width: 150px">Insurance Passed?</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
