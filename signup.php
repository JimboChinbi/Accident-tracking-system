...
<body style=" background-size: cover; background-position: center;">
    ...
    <div class="container-fluid row">
        <a class="navbar-brand col-sm-12 col-lg-10 caption" href="#" style="color: #F8F8F8 ;">Accident Claim System</a>
    </div>
</nav>

    <div class="container">
    <div class="col-lg-11 col-sm-10 text-light mx-auto pt-5 pb-2 shadow-lg" style="margin-top: 10%; background: url('./images/black.jpg.jpg') center/cover no-repeat; border-radius: 25px;">

            <form action="./controllers/handle-registration.php" method="post" name="signup-form" onsubmit="return validateForm();" novalidate>
