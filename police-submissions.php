    ...
    if ($result_user){
        ...
        if (!isset ($_GET['submission_filter']) ) {
            ...
            if ($search == "all"){
                ...
                $sql = "SELECT * FROM Incidents WHERE police_status = '$search' LIMIT ".$page_first_result.",".$results_per_page;
                $result_data = mysqli_query($conn, $sql);
            }
        }
    }else{
...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding-left: 30px; padding-right: 30px; background-color: #5632D9 !important;">
    <div class="container-fluid row">
        ...
        <ul class="desktop navbar-nav ml-auto" style="max-width: fit-content">
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="police-admin-home.php"  style="color: #F8F8F8 !important;">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="police-submissions.php"  style="color: #F8F8F8 !important;font-weight: bold;">Submissions</a>
            </li>
        </ul>
    </div>
</nav>
        ...
        <form>
            <div class="col-10 mx-auto">
                <div class="row text-center mb-5 mt-3">
                    <h1 class="mt-4 mb-4">Submission Details</h1>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-light shadow-lg table-bordered" style="margin-top: 8%; margin-top: 8%;">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="align-middle" style="min-width: 150px">Police Report Passed?</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
